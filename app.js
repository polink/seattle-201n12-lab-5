...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sumSum = sum(sum(sumArr[0],sumArr[1])[0], sumArr[2])[0];
  var sumString = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sum(sum(sumArr[0],sumArr[1])[0], sumArr[2])[0]} is their sum.`;
  var plusPlus = [sumSum, sumString];
  //console.log(plusPlus[0],plusPlus[1]);
...
function multiplyArray(multiArr) { //eslint-disable-line
  ...
  var timesMulti = multiply(multiply(multiArr[0],multiArr[1])[0], multiArr[2])[0];
  var timesString = `The numbers ${multiArr[0]},${multiArr[1]},${multiArr[2]} have a product of ${multiply(multiply(multiArr[0],multiArr[1])[0], multiArr[2])[0]}.`;
  var multiMulti = [timesMulti,timesString];
  //console.log(multiMulti);
  return multiMulti;
}  
...
//    var plusPlus = sum(int, sumArr[i+1] /*should be variable that represents the next step in the array */);
